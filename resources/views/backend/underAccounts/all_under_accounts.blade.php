...
@section('admin')
      ...
      <nav class="page-breadcrumb">
                  <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('add.under-account')}}" class="btn btn-inverse-secondary">Ajouetr Sous Compte</a></li>
...
<div class="card">
  <div class="card-body">
    <h6 class="card-title">Les Sous Comptes</h6>
    ...
    <div class="table-responsive">
                  <table id="dataTableExample" class="table table-striped">
                    ...
                    <tbody>
                    @foreach ($underAccounts as $key => $item)
                    <tr>
                        <td>{{$key+1}}</td>
